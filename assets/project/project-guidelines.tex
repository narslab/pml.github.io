...
Submit your final presentation as a PDF.
For now, I will require that you include a working link to a Github repository in your presentation.
%Github is %preferred, as an R script/package, Python script/package or Jupyter Lab/Notebook.
...
\begin{tabular}{m{1in} m{1in} m{3.5in} m{.5in}}\toprule
  ...
  \multirow{4}{*}{\textbf{Presentation}} %& Organization  & Clear structure and required elements  & 5 \\\cmidrule{2-4}
                &  \multirow{3}{*}{Content} & Adequate data description and figures & 5\\\cmidrule{3-4}
                & & Adequate model descriptions & 5\\\cmidrule{3-4}
                & & Thoroughness of results & 5 \\\cmidrule{3-4}
                & & Adequate conclusions & 5 \\\cmidrule{3-4}
                & & Clarity and quality of slides & 5 \\\cmidrule{2-4}
...
%  & Question & Adequate responses to post-presentation questions & 5 \\
 % & Final version submitted with corrections addressed (if any)& 5 \\\midrule
  \textbf{Code} &  Organization & Organized and runnable, with reproducible results & 5 \\ \midrule
